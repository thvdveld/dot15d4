...
use super::constants::{A_UNIT_BACKOFF_PERIOD, SYMBOL_RATE_INV_US};
...
pub const MAC_UNIT_BACKOFF_DURATION: Duration =
    Duration::from_us((A_UNIT_BACKOFF_PERIOD * SYMBOL_RATE_INV_US) as i64);
...
pub const ACKNOWLEDGEMENT_INTERYFRAME_SPACING: Duration = Duration::from_us(1);
