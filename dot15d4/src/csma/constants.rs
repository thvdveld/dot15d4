...
pub const A_BASE_SUPERFRAME_DURATION: u32 = A_BASE_SLOT_DURATION * A_NUM_SUPERFRAME_SLOTS;
/// The number of superframes in which a GTS descriptor exists in the beacon frame of the PAN coordinator.
pub const A_GTS_DESC_PERSISTENCE_TIME: u32 = 4;
